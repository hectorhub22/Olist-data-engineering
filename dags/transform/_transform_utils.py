...
def refresh_curated_tables() -> None:
    ...
    statements = [
        ...
        """,
        """
        DROP TABLE IF EXISTS curated.orders;
        ...
        """,
        """
        DROP TABLE IF EXISTS curated.order_items;
        CREATE TABLE curated.order_items AS
        SELECT DISTINCT
            NULLIF(order_id, '') AS order_id,
        ...
        """,
        """
        DROP TABLE IF EXISTS curated.order_payments;
        CREATE TABLE curated.order_payments AS
        SELECT DISTINCT
            NULLIF(order_id, '') AS order_id,
        ...
        """,
        """
        DROP TABLE IF EXISTS curated.order_reviews;
        CREATE TABLE curated.order_reviews AS
        SELECT DISTINCT
        ...
        CREATE TABLE curated.products AS
        SELECT DISTINCT
            NULLIF(product_id, '') AS product_id,
        ...
        """,
        """
        DROP TABLE IF EXISTS curated.sellers;
        CREATE TABLE curated.sellers AS
        SELECT DISTINCT
            NULLIF(seller_id, '') AS seller_id,
